...
from nsbplib.upper_level_problems import UpperScalarDataLearning
...
upper_level_problem = UpperScalarDataLearning(ds_dir=dataset_dir,num_training_data=size_training_set,verbose=True)
...
# Save the results
save_nsbpl_results(evals=evals,sol=sol,extra_data=extra_data,outfolder=output_dir,run_name=os.path.basename(dataset_dir))