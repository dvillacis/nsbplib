...
from nsbplib.upper_level_problems import UpperPatchDataLearning
...
upper_level_problem = UpperPatchDataLearning(ds_dir=dataset_dir,num_training_data=size_training_set,px=args.patch_size,py=args.patch_size,verbose=True)

x0 = load_start_parameter(35.47,px=args.patch_size,py=args.patch_size)
...
# Save the results
save_nsbpl_results(evals=evals,sol=sol,extra_data=extra_data,outfolder=output_dir,run_name=f'{os.path.basename(dataset_dir)}_px{args.patch_size}_py{args.patch_size}')